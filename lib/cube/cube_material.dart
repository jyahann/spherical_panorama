...
/// Loading material from CubeMaterial Library File (.mtl).
/// Reference：http://paulbourke.net/dataformats/mtl/
///
Future<Map<String, CubeMaterial>> loadMtl(String fileName, {bool isAsset = true}) async {
  final materials = Map<String, CubeMaterial>();
  String data;
  try {
    if (isAsset) {
  ...
  CubeMaterial material = CubeMaterial();
...
Future<MapEntry<String, Image>?> loadTexture(CubeMaterial? material, String basePath, {bool isAsset = true}) async {
